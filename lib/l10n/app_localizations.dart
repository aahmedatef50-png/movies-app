...
abstract class AppLocalizations {
  ...
  /// No description provided for @dont_havea_ccount.
  ///
  /// In en, this message translates to:
  /// **'Don’t Have Account ?'**
  String get dont_havea_ccount;
  ...
  /// No description provided for @intro_body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @onboarding1_body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @onboarding2_body.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @onboarding3_body.
  ///
  /// In en, this message translates to:
  /// **'Save movies to your watchlist to keep track of what you want to watch next. Enjoy films in various qualities and genres.'**
  String get onboarding3_body;

  /// No description provided for @onboarding4_title.
  ///
  /// In en, this message translates to:
  /// **'Rate, Review, and Learn'**
  String get onboarding4_title;

  /// No description provided for @onboarding4_body.
  ///
  /// In en, this message translates to:
  /// **'Share your thoughts on the movies you\'ve watched. Dive deep into film details and help others discover great movies with your reviews.'**
  String get onboarding4_body;

  /// No description provided for @onboarding5_title.
  ///
  /// In en, this message translates to:
  /// **'Start Watching Now'**
  ...
  /// No description provided for @already_havea_account.
  ///
  /// In en, this message translates to:
  /// **'Already Have Account ?'**
  String get already_havea_account;
