...
import 'package:my_movies_app/ui/auth/forget_password_screen/cubit/forget_password_view_model.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<ForgetPasswordViewModel, ForgetPasswordStates>(
      ...
      buildWhen: (previous, current) {
        return current is ForgetPasswordInitialState;
      },
      ...
      listener: (context, state) {
        if (state is ForgetPasswordLoadingState) {
          UtilsDialog.showLoading(
              context: context, content: state.loadingMessage);
        } else if (state is ForgetPasswordSuccessState) {
          UtilsDialog.hideDialog(context: context);
          UtilsDialog.showMessage(context: context,
